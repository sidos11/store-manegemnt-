...
class _ProductScreenState extends State<ProductScreen> {
  ...
  void _navigateToAddProduct() {
    Navigator.pushNamed(context, '/add-product').then((_) {
      // ✅ Recharge automatiquement la liste au retour depuis l'écran d'ajout
      if (mounted) {
        context.read<ProductController>().loadProducts();
      }
    });
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Sync dynamique avec les données du backend
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          // ✅ Grille premium 2 colonnes ou état vide
              ...
              : SliverPadding(
                  ...
                  sliver: SliverGrid(
                    gridDelegate:
                      ...
                      crossAxisSpacing: 16,
                      mainAxisSpacing: 16,
                      childAspectRatio: 0.78, // ✅ Ratio premium conservé
                    ),
  ...
  // ✅ Carte produit premium conservée intégralement
